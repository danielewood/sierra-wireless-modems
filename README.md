...
+ For every use other than installing in a Lenovo \*70 Series.
    ...
    + When purchasing the Dell, I would recommend you get a production model. Engineering Sample will sometimes contain an early (SWI9X30C_00.08.02.00) firmware that can be a royal pain to flash to something current.
